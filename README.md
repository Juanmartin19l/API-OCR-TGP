...
API REST para extracción de texto a partir de imágenes y PDFs usando PaddleOCR. Proporciona un endpoint HTTP para procesar uno o varios archivos y devuelve resultados estructurados por archivo. 
